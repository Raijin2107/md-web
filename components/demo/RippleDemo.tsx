            ...
            <div className="p-8 space-y-12">
                <section>
                    ...
                    <div className="flex flex-wrap gap-8">
                        ...
                        <div className="relative w-32 h-32 rounded-xl flex items-center justify-center cursor-pointer overflow-hidden border border-primary/10 dark:border-zinc-700 group">
                            <Ripple />
                        ...
                        <div className="relative w-48 h-32 border-2 border-dashed border-zinc-300 dark:border-zinc-600 rounded-xl flex items-center justify-center cursor-pointer overflow-hidden hover:bg-primary/25 dark:hover:bg-zinc-900 transition-colors">
                            <Ripple />
                            <span className="text-sm italic">Dashed Border</span>
                        </div>

                        {/* Disabled Surface with Ripple */}
                        <div className="relative w-32 h-32  bg-primary/3 rounded-xl flex items-center justify-center cursor-not-allowed overflow-hidden border   opacity-50">
                            <Ripple disabled />
                ...
                <section>
                    ...
                    <div className="max-w-xs relative bg-primary/3 border border-primary/10  rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer group">
                        <Ripple />
                ...
                <section className="p-6 rounded-2xl border border-primary/10 dark:border-zinc-700">
